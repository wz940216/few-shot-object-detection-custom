...
COCO_CATEGORIES = [
    # custom
    {"color": [220, 20, 60], "isthing": 1, "id": 0, "name": "fasi"},
    {"color": [119, 11, 32], "isthing": 1, "id": 1, "name": "heidian"},
    {"color": [0, 0, 142], "isthing": 1, "id": 2, "name": "yiwu"},
...
COCO_NOVEL_CATEGORIES = [
    ...
    {"color": [220, 20, 60], "isthing": 1, "id": 1, "name": "heidian"},
    {"color": [119, 11, 32], "isthing": 1, "id": 2, "name": "yiwu"},
...
def _get_coco_instances_meta():
    ...
    assert len(thing_ids) == 3, len(thing_ids)  # @wangzheng 80
